...
export function httpsRows(): readonly RustProviderOperationDefinition[] {
  ...
  return [
    ...
    { ...serverMethod("listen", "port,callback", "listen_default_host", [{ kind: "type-parameter", name: "Port" }, emptyCallbackCarrier], ["value", "value"], mutableServer, true), genericParameters: [{ kind: "type", sourceName: "Port" }] },
    { ...serverMethod("listen", "port,host,callback", "listen", [{ kind: "type-parameter", name: "Port" }, stringCarrier, emptyCallbackCarrier], ["value", "ref", "value"], mutableServer, true), genericParameters: [{ kind: "type", sourceName: "Port" }] },
