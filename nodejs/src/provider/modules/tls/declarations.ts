import { uint64Carrier, boolCarrier, emptyCallbackCarrier, stringArrayCarrier, stringCarrier, unitCarrier } from "../../model/carriers.js";
import { rustSourcePrimitiveTargetType, rustOptionTargetType } from "@tsonic/target-rust/provider";
...
export function tlsRows(): readonly RustProviderOperationDefinition[] {
  ...
  return [
    ...optionRows(connectOptionsId, tlsConnectOptionsCarrier, [
      ...
      ["port", "port", rustOptionTargetType(rustSourcePrimitiveTargetType("uint16"))],
      ...
      ["timeout", "timeout", rustOptionTargetType(uint64Carrier)],
    ]),
    ...
    { ...serverMethod("listen", "port,callback", "listen_default_host_callable", [{ kind: "type-parameter", name: "Port" }, emptyCallbackCarrier], ["value", "value"], mutableServer, true), genericParameters: [{ kind: "type", sourceName: "Port" }] },
    { ...serverMethod("listen", "port,host,callback", "listen_callable", [{ kind: "type-parameter", name: "Port" }, stringCarrier, emptyCallbackCarrier], ["value", "ref", "value"], mutableServer, true), genericParameters: [{ kind: "type", sourceName: "Port" }] },
